        ...
        <div className='md:w-1/3 w-full'>
          ...
          <div className='flex flex-col gap-4 mt-5'>
            <ul className='flex flex-col gap-3'>
              <li className='flex items-center justify-left gap-2'><MdOutlineLocationOn size={24} /> <span>New Delhi,794309</span></li>
              <li className='flex items-center justify-left gap-2'><MdOutlineLocalPhone size={24} /> <span>+91 7883 755 494</span></li>
              <li className='flex items-center justify-left gap-2'><MdMailOutline size={24} /><span>contact@dkraj.com</span></li>
