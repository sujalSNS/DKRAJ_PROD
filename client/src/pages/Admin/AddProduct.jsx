...
export const AddProduct = ({ toggleDrawer }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            delete product.imgs;
            console.log("final productData", product)
            ...
            const response = await axios.post('http://localhost:5000/api/product/create', product, config);
                ...
                <div className="px-4 md:px-12 pt-5 pb-12 flex flex-col items-center">
                    <div className="md:w-2/4">
                        ...
                        <form ref={formRef} onSubmit={handleSubmit} className="max-w-lg mx-auto">
                            ...
                            <button type="submit" className="bg-black hover:bg-white hover:text-black border border-black text-white font-medium w-full py-2 px-4 ">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
